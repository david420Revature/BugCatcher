package com.revature.steps.manual.login;
...
public class Login {
    ...
    private static Matrix guiWidget;
    @Before
    public void setup() {
        WebDriver driver = new ChromeDriver();
        page = new Page(driver);
        guiWidget = new Matrix(driver);
    }
    ...
    public void employeeTypesUsername(String username) {
        guiWidget.prompt("put in username " + username, "The user stopped of failed the test");
    }
